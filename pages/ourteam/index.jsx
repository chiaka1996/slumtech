...
export default function OurTeam() {
  return (
   <main className="text-primary">
    ...
    <Navigation />
    <Sidebar /> 
    <section className="flex flex-row w-[90%] mr-[10%] mt-[12em]">
        <div className="relative w-[50%] h-[28em]">
        <Image 
        ...
        <div className="ml-[5em] text-basic w-[40%]">
            <header className="font-h2 text-[48px]">
            Join Us in Building a <br/>
            Brighter Future
            </header>

            <p className="text-h2 font-normal mt-[1em]">
            ...
            <div className="flex flex-row items-center mt-[1em]">
                <button className="px-4 py-3 bg-btn_bg rounded-[12px] border border-btn_bg font-h2 text-[#fff] text-[1em] mr-[2em]">
                    JOIN US AS A VOLUNTEER
                </button>
                <button className="p-3 bg-transparent rounded-[12px] border border-btn_bg font-h2 text-btn_bg text-[1em]">
                    Careers
                </button>
    ...
    <section>
        <div className=" py-[5em] px-[7em] mx-auto mt-[8em] min-h-[28em] w-[55%] rounded-[21px] bg-cover bg-no-repeat bg-[url('/images/team-background1.png')]">
        <header className="font-h2 text-[22px] text-basic">What SlumTech Institute will offer</header>
        <div>
            <ul className="list-disc pl-6 font-normal text-secondary text-basic">
                <li className="mt-[1em] ">
        ...
        <div className="text-primary py-[5em] px-[7em] mx-auto mt-[3em] min-h-[28em] w-[55%] rounded-[21px] bg-cover bg-no-repeat bg-[url('/images/team-background2.png')]">
    ...
    <section className="rounded-[20px] bg-btn_bg w-[70%] mx-auto px-[7em] py-[1em] mt-[3em] text-[#fff] font-normal text-secondary">
    ...
    <div className="w-[70%] mx-auto  my-[3em]">
    ...
    <p className="text-secondary text-center text-primary font-normal px-[4em] mt-[1em]">
