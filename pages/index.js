  ...
  return (
   <main className="relative overflow-hidden font-primary">
    ...
    <div className="mt-[4%] max-large:mt-[22%] w-full h-[100vh] max-large:h-[300px] relative">
      <div className="animate__animated animate__slower animate__slideInLeft absolute top-[10%] 2xl:top-[15%] max-large:top-[3%] left-[10%] xlarge:left-[15%] max-large:left-[5%] w-[52%] max-large:w-[90%] xlarge:w-[35%] z-30">  
