  ...
  return (
   <main className="relative overflow-hidden font-primary">
    ...
    <div className="mt-[4%] max-large:mt-[22%] w-full h-[100vh] max-large:h-[300px] relative">
      <div className="animate__animated animate__slower animate__slideInLeft absolute top-[10%] xlarge:top-[15%] max-large:top-[3%] left-[10%] xlarge:left-[15%] max-large:left-[5%] w-[50%] max-large:w-[90%] xlarge:w-[35%] z-30">  
   ...
   <div className="absolute top-[30%] z-50  max-large:top-[20%] right-[30%]  max-large:right-[50%] w-[9.1rem] xlarge:w-[11em]">
    ...
    <div className="z-10 absolute top-[5%] left-[10%] xlarge:left-[15%]">
      ...
      <Image 
        ...
        {/* w-[23.875em] */}
      <div className="w-[45%] max-large:w-full h-[70vh] xlarge:h-[48em] max-large:h-[250px] relative">
      <Image 
